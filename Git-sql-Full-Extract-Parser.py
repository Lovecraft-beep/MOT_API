...
# Write test details to db
                    test_deets = [(testNumber, result, testDate, odovalue, expiry)]

                    param = """INSERT INTO mottests (testnumber, result, date, mileage, expiry) VALUES (?,?,?,?,?);"""
...
# write RFR details to db
                        rf_deets = [(text, ftype, dang)]
                        param = """INSERT INTO rfrs (advisory, type, danger) VALUES (?,?,?);"""
